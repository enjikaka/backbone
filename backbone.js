...
(function (factory) {
  ...
  _.extend(Model.prototype, Events, {
    ...
    matches (attrs) {
      return Boolean(_.iteratee(attrs, this)(this.attributes));
    },
  ...
  CollectionIterator.prototype.next = function () {
    if (this._collection) {
      ...
      this._collection = void 0; // eslint-disable-line
    }

    return { value: void 0, done: true }; // eslint-disable-line
  };
  ...
  _.extend(View.prototype, Events, {
    ...
    delegateEvents (events = _.result(this, 'events')) {
      if (!events) {
        return this;
      }
  ...
  _.extend(History.prototype, Events, {
    ...
    start (options) {
      ...
      this._hasPushState = Boolean(this.history && this.history.pushState);
      ...
      if (!this._hasHashChange && this._wantsHashChange && !this._usePushState) {
        ...
        this.iframe.src = 'javascript:0'; // eslint-disable-line
    ...
    navigate (fragment, options) {
      ...
      if (!options || options === true) {
        options = { trigger: Boolean(options) };
      }
